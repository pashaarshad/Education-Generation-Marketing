...
export default function Problem() {
  ...
  return (
    <section id="problems" className="py-24 relative overflow-hidden">
      ...
      {/* Background glow */}
      <div className="gradient-blob w-[400px] h-[400px] bg-red-950/10 top-[20%] right-[-10%]" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {problems.map((prob, idx) => {
            ...
            return (
              <motion.div
                ...
                key={idx}
                className="glass-panel rounded-2xl p-6 border border-white/5 bg-brand-dark/50 flex flex-col justify-between hover:border-rose-500/20 transition-all duration-300 group"
              >
                <div>
                  <div className="w-9 h-9 rounded-lg bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-400 mb-4 group-hover:scale-105 transition-transform">
                ...
                <div className="flex items-center gap-1.5 text-2xs font-semibold text-rose-400/70 mt-6 group-hover:text-rose-400 transition-colors">
          ...
          <motion.div
            ...
            className="glass-panel rounded-2xl p-6 border border-brand-purple/20 bg-gradient-to-br from-brand-purple/10 to-transparent flex flex-col justify-between lg:col-span-1"
          >
            <div>
              <div className="w-9 h-9 rounded-lg bg-brand-purple/20 border border-brand-purple/30 flex items-center justify-center text-brand-violet mb-4">
            ...
            <button
              ...
              className="w-full py-3 mt-6 rounded-xl font-semibold bg-brand-purple hover:bg-brand-violet text-white transition-all duration-300 text-xs text-center cursor-pointer shadow-[0_0_15px_rgba(124,58,237,0.2)]"
            >
        ...
        {/* Warning Callout Box */}
        <div className="p-6 rounded-2xl bg-rose-950/20 border border-rose-500/10 flex flex-col md:flex-row items-center justify-between gap-6 max-w-4xl mx-auto shadow-[0_0_30px_rgba(244,63,94,0.05)]">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-rose-500/10 border border-rose-500/20 flex items-center justify-center shrink-0 text-rose-400">
              <AlertCircle className="w-6 h-6 animate-pulse" />
            </div>
            <div>
              <h4 className="text-sm md:text-base font-bold text-white">The Hidden Danger of Broker Agents</h4>
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-lg text-xs font-semibold border border-rose-500/30 text-rose-400 hover:bg-rose-500 hover:text-white transition-all cursor-pointer whitespace-nowrap"
          >
